...
For remote models inside ComfyUI, install custom nodes in your ComfyUI user directory. This repo has been tested with:

```bash
cd /Users/t.willems/Documents/ComfyUI/custom_nodes
git clone https://github.com/gokayfem/ComfyUI-fal-API.git
/Users/t.willems/Documents/ComfyUI/.venv/bin/python -m pip install -r ComfyUI-fal-API/requirements.txt
```
